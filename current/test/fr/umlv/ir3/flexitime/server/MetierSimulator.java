...
public class MetierSimulator
{
    ...
    public static void generate()
    {
        ...
        videoproj2 = DataFactorySansRmi.createDevice("VideoProj2", IDevice.VIDEOPROJECTOR);
        ...
        mfpi = DataFactorySansRmi.createTrack("MFPI");
        gm = DataFactorySansRmi.createTrack("GM");
        ...
        ts_ir2 = DataFactorySansRmi.createTeachingStructure("ts ir 2", ir2);
        ts_ir3 = DataFactorySansRmi.createTeachingStructure("ts ir 3", ir3);
        ...
        lesson5 = DataFactorySansRmi.createLesson(new Gap(2005,1,6,8,30,2005,1,6,10,30), corba_td, groups_td, roussel);
