    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(login!=null){
            ...
            if(stepbefore!=null){
                ...
                JRessourcePlanning fe = new JRessourcePlanning(new RessourcePlanningModel(MetierSimulatorSansRmi.get2017(),g));
                request.setAttribute("edt",fe.getLigne());
                request.setAttribute("login",login);
                String longName = Authentification.getLongName(login);
                request.setAttribute("longName",longName);
                ...
                /*try
                {
                    List ic = RemoteDataManager.getManager().getTracks();
