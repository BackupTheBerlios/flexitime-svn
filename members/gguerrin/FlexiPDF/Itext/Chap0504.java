...
/*
 * $Id: Chap0504.java,v 1.5 2003/06/25 07:36:33 blowagie Exp $
 * $Name:  $
 *
...
public class Chap0504 {
    ...
    public static void main(String[] args) {
        ...
        try {
			...
			aTable.addCell("4.0", new Point(4,0)); 
			aTable.addCell("4.1", new Point(4,1)); 
			aTable.addCell("4.2", new Point(4,2));
			aTable.addCell("4.3", new Point(4,3));
            document.add(aTable);  
