...
<td><%=listtracks%></td>
<td><input type="submit" name="trackssubmit" value="Valider"></td>
<%if(listclasses!=null){%>
<td><%=listclasses%></td>
<td><input type="submit" name="classsubmit" value="Valider"></td>
<%if(listgroups!=null){%>
<td><%=listgroups%></td>
<td><input type="submit" name="groupssubmit" value="Valider"></td>
<%}}}%>
</tr></table>
</form>
<%
