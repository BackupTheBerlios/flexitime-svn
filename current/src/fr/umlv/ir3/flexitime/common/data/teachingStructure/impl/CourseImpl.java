...
public class CourseImpl extends DataImpl implements ICourse
{
    ...
    /**
     * Test the equality of two course.
     * 
     * @param obj
     *            other course to compare with
    ...
    public boolean equals(Object obj)
    {
        ...
        if (! ( obj instanceof ICourse )) return false;
        ICourse other = (ICourse) obj;
        ...
        if (idData == null)
        {
            ...
            {
                if(parentSubject.equals(other.getParentSubject()))
