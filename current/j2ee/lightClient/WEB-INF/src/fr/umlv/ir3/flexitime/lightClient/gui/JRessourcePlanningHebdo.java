...
public class JRessourcePlanningHebdo 
{
    ...
    private void createDayLign()
    {
        ...
        for (int i = 0 ; i < model.getNbDays() ; i++){
            ligne = ligne.concat("<td align=\"center\" width=\"20%\" background=\"/res/header_r4_c5.jpg\"><b><font size=\"2\">"+addDayHeader(i)+"</font></b></td>");
        }
    ...
    { 
        ligne = ligne.concat("<td valign=\"top\" width=\"120\">"+addHourTable()+"</td>");
            for (int i = 0 ; i < model.getNbDays() ; i++)
            {
