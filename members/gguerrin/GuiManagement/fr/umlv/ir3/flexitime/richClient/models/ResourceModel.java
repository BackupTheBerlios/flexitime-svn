 ...
 */
public class ResourceModel extends DefaultTreeModel {
	 ...
	 * @param book the book
	 */
	public ResourceModel(TreeNode node)
	{
		super(node);
	 ...
	 */
	public void add(TreeNode tree,List value)
	{
		((FlexiTreeNode)tree).add(value);
	}
