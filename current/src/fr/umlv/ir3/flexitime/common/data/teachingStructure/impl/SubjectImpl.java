...
public class SubjectImpl extends DataImpl implements ISubject
{
    ...
    /**
     * Test the equality of two subject.
     * 
     * @param obj
     *            other subject to compare with
    ...
    public boolean equals(Object obj)
    {
        ...
        if (! ( obj instanceof ISubject )) return false;
        ISubject other = (ISubject) obj;
        ...
        if (idData == null)
        {
            if (this.getName().equals(other.getName()))
                return parentSubjectsGroup.equals(other.getParentSubjectsGroup());
            return false;
        }
