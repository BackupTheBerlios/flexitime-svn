...
/**
 * 
 * Time - DOCME Description
 * Tool for time
 * This Class allows the users to work with Time Object
 * And to have it under different kinds 
 * 
 * @version 0.1
 * 
...
public class Time {
	 ...
	 * @return the str transformed in Time
	 * 
	 * @author   FlexiTeam - Guillaume GUERRIN
	 * @date     14 déc. 2004
	 */
	 ...
	 *
	 * @param t the Time
	 * @return the timetransformed in String
	 * 
	 * @author   FlexiTeam - Guillaume GUERRIN
	 * @date     14 déc. 2004
	 */
	 ...
	 *
	 * @param t the Time 
	 * @return the Time transformed in Long
	 * 
	 * @author   FlexiTeam - Guillaume GUERRIN
	 * @date     14 déc. 2004
	 */
	 ...
	 *
	 * @param l the Long 
	 * @return the Long transformed in Time
	 * 
	 * @author   FlexiTeam - Guillaume GUERRIN
	 * @date     14 déc. 2004
	 */
	 ...
	 *
	 * @param da the Date
	 * @return the date extrat from the Date
	 * 
	 * @author   FlexiTeam - Guillaume GUERRIN
	 * @date     14 déc. 2004
	 */
	public static Date recupDate(Date da){return null;}
