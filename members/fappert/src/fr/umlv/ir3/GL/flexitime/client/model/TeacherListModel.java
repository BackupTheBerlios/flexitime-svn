...
public class TeacherListModel extends AbstractListModel{
	...
	public class TeacherListener implements ITeacherListener, Serializable{
	...
	public TeacherListModel() {
		...
		try {
			...
			try {
				TeacherListener l = new TeacherListener();
				UnicastRemoteObject.exportObject(l);
			      Naming.rebind ("//127.0.0.1/TeacherListener", l);
			      System.out.println ("Flexitime Client is ready.");
			      System.out.println ("TeacherListener register");
			    } catch (Exception e) {
			      System.out.println ("Flexitime Client failed: " + e);
			    }
			metier.addMetierListener("rmi://127.0.0.1/TeacherListener");
