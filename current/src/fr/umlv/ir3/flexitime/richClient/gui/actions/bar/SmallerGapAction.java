...
/**
 * An action implementation useful for reducing the precision of the grid to put a lesson into.
 * 
 * @version 0.1
 * 
...
public class SmallerGapAction extends AbstractAction
{
    ...
    private static Icon icon = Client.getIcon(Client.class, "pictures/_gapSmall2.png");
