...
public class ConfigurationManager implements IConfigurationManager
{
    ...
    public IConfig get() throws SAXException, ParserConfigurationException, IOException
    {
        ...
        {
            String fileName = System.getProperty("fr.umlv.ir3.flexitime.configfile", "flexiConfig.xml");
            File f = new File(fileName);
            InputSource inSrc = new InputSource(new FileReader(f));
            try
            {
    ...
    private void closeElem(FileOutputStream out, String root) throws IOException
    {
        out.write("</".getBytes());
    ...
    private void openElem(FileOutputStream out, String root, int i) throws IOException
    {
        for (int j = 0 ; j < i ; j++)
            out.write("\t".getBytes());
        out.write("<".getBytes());
