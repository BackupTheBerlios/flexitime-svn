...
public class BasicDnD extends JPanel implements ActionListener {
    ...
    public BasicDnD() {
        ...
        JPanel sidePanel = createSideBoxPanel();
        ...
        label = new JLabel(new ImageIcon("icon.gif"));
        label.addMouseMotionListener(new iconMouseMotionListener(label));
        //icon = new ImageIcon(BasicDnD.class.getResource("icon.gif"));
        sidePanel.add(label);
    ...
    protected JPanel createSideBoxPanel() {
        JPanel p = new JPanel();
        p.setLayout(new BoxLayout(p, BoxLayout.PAGE_AXIS));
       //p.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
        return p;
