...
public class MetierSimulatorSansRmi
{
    ...
    public static void generate()
    {
        ...
        j2ee_cours = DataFactorySansRmi.createCourse("Cours J2EE", ir3_bloc1_sub1 , ICourse.CM, 120, 20 , Color.MAGENTA, createList(roussel));
        j2ee_td = DataFactorySansRmi.createCourse("TD J2EE", ir3_bloc1_sub1 , ICourse.TD, 240, 20 , Color.MAGENTA, createList(roussel));
        gl_cours = DataFactorySansRmi.createCourse("Cours GL", ir3_bloc1_sub2 , ICourse.CM, 120, 20 , Color.CYAN, createList(revuz));
        gl_td = DataFactorySansRmi.createCourse("TD GL", ir3_bloc1_sub2 , ICourse.TD, 120, 20 , Color.BLUE, createList(revuz));
        ...
        lesson1 = DataFactorySansRmi.createLesson(new Gap(2005,1,24,8,30,2005,1,24,10,30), j2ee_cours, groups_cm);
        lesson2 = DataFactorySansRmi.createLesson(new Gap(2005,1,25,13,45,2005,1,25,15,45), corba_cours, groups_cm, midonnet);        
        lesson3 = DataFactorySansRmi.createLesson(new Gap(2005,1,26,16,00,2005,1,26,18,00), gl_cours, groups_cm, revuz);
        lesson4 = DataFactorySansRmi.createLesson(new Gap(2005,1,27,8,30,2005,1,27,10,30), gl_td, groups_td, revuz);
        lesson5 = DataFactorySansRmi.createLesson(new Gap(2005,1,28,8,30,2005,1,28,10,30), corba_td, groups_td, roussel);
        lesson6 = DataFactorySansRmi.createLesson(new Gap(2005,1,31,8,30,2005,1,31,10,30), corba_td, groups_td, roussel);
        lesson7 = DataFactorySansRmi.createLesson(new Gap(2005,1,32,8,30,2005,1,32,10,30), corba_td, groups_td, roussel);
        lesson8 = DataFactorySansRmi.createLesson(new Gap(2005,1,33,8,30,2005,1,33,10,30), corba_td, groups_td, roussel);
        lesson9 = DataFactorySansRmi.createLesson(new Gap(2005,1,34,8,30,2005,1,34,10,30), corba_td, groups_td, roussel);
